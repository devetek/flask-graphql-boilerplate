...
# source: rpc/modules/calculator/calculator.proto
...
Number = _reflection.GeneratedProtocolMessageType('Number', (_message.Message,), dict(
  DESCRIPTOR = _NUMBER,
  __module__ = 'rpc.modules.calculator.calculator_pb2'
